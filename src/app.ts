...
import { RegisterRoutes } from "./common/swagger/routes";
import swaggerDoc from "./common/swagger/swagger.json";
import swaggerUi from "swagger-ui-express";
import favicon from "serve-favicon";
var path = require("path");
import { ValidateError } from "tsoa";
import passportConfig from "./common/passport/passport-config";
...
class App {
  ...
  private connectToDatabase() {
    const { MONGO_CONNECTION_STRING, MONGO_BASE_DB } =
      process.env;
    if (this.env) {
      // production database
